...
const subjectImagesByGrade: Record<string, Record<string, string>> = {
  ...
  "10": {
    ...
    "Afaan Oromro": "/assets/courses/afaanoromo10.png",
...
const FreeExam: React.FC = () => {
  const navigate = useNavigate();
  const [step, setStep] = useState<"grade" | "stream" | "semester" | "subjects" | "exams">("grade");
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 relative">
      ...
      <div className="flex flex-col items-center">
        <h1 className="text-3xl font-bold text-blue-700 mb-6">Free Exam</h1>

        {/* Recommendations */}
        {step === "grade" && (
          <p className="text-center mb-6 max-w-3xl">
            🎯 Choose your grade carefully. This ensures the exams match your level. If unsure, select your current class.
          </p>
        )}
        {step === "stream" && (
          <p className="text-center mb-6 max-w-3xl">
            🔬 Choose your stream (Natural Science or Social Science) to see the right subjects for your grade.
          </p>
        )}
        {step === "semester" && (
          <p className="text-center mb-6 max-w-3xl">
            📚 Select the semester to match your syllabus. Entrance exams skip this step.
          </p>
        )}
        {step === "subjects" && (
          <p className="text-center mb-6 max-w-3xl">
            ✅ Select a subject to see available Midterms and Final exams. Practice smartly and retake if needed.
          </p>
        )}
        {step === "exams" && (
          <p className="text-center mb-6 max-w-3xl">
            📌 Choose a specific exam. Focus and complete honestly — cheating is forbidden.
          </p>
        )}
            ...
            {streams.map((stream) => (
              <div
                ...
                onClick={() => {
                  ...
                  setStep(selectedGrade === "Entrance" ? "subjects" : "semester");
                }}
              >
