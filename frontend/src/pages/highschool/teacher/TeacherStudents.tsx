...
const TeacherStudents: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${BACKEND_URL}/teachers/students`, {
    ...
    <div className="p-3 bg-gray-100 min-h-screen">
      ...
      <div className="max-w-md mx-auto mb-6">
        <input
          ...
          className="w-full p-3 rounded-lg shadow border focus:ring-2 focus:ring-green-500"
        />
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full p-6 relative">
            ...
            <img
              ...
              className="w-36 h-36 mx-auto border-4 border-green-500 rounded-xl my-4"
            />
